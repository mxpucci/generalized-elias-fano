...
echo "  1. compression_ratio_by_compressor.png"
echo "  2. compression_throughput_by_compressor.png"
echo "  3. decompression_throughput_by_compressor.png"
echo "  4. multi_metric_comparison.png"
echo ""
